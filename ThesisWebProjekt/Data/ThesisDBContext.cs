    ...
    {      
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var x = modelBuilder.Entity<Thesis>().HasData(
                     new Models.Thesis() { Id = 1, Title = "Bachelorthema 1", Description = "...", Bachelor = true, Master = false, Type = ThesisType.Bachelor, Status = Status.Free, LehrstuhlId = 10, StudiengangId = 1 },
                     ...
                     new Models.Thesis() { Id = 3, Title = "Masterthema 1", Description = "...", Bachelor = false, Master = true, Type = ThesisType.Master, Status = Status.Free, LehrstuhlId = 11, StudiengangId = 3 },
